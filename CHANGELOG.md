...
- Fixes some linting errors. [0be5296](https://github.com/callowayproject/project-forge/commit/0be52966cb4b09ab76fa37673646e83497424001)

- Refactor logging setup, improve `nested_overwrite` type handling, and update `TEMPORARY_CACHE_DIR` initialization. [444a0d8](https://github.com/callowayproject/project-forge/commit/444a0d875d703842ba2f3b3922ad318da875a65e)

- Refactor variable naming in template rendering for improved readability. [3772982](https://github.com/callowayproject/project-forge/commit/3772982547b6a775ac664fa59086504a38564ed4)

- Fix syntax for capturing current version in workflow output. [1a2b4da](https://github.com/callowayproject/project-forge/commit/1a2b4da6772405dbc526f64999c76c9930f3e4d2)

  Adjusted the syntax for capturing and writing the current version to `$GITHUB_OUTPUT` in the bump-version workflow. This ensures proper evaluation of the `bump-my-version` command output.

### New

- Add `nested-overwrite` merge method to `MERGE_FUNCTION` and corresponding test. [7ddc650](https://github.com/callowayproject/project-forge/commit/7ddc6509b57815cbe2e5f7f917e6ce4dc3ab441a)

- Add tests for deeply nested templates, expression caching, indented logger, and merge method validation. [ceb1047](https://github.com/callowayproject/project-forge/commit/ceb10473b8921b43aa58ad3b5448424863b257e3)

- Add verbosity option and integrate logging setup for CLI build command. [f6009ba](https://github.com/callowayproject/project-forge/commit/f6009ba119a2f081cd27a2fc1572cd679c01ac2d)

- Add `IndentedLoggerAdapter` for structured and indented logging. [7ee48fa](https://github.com/callowayproject/project-forge/commit/7ee48fa65b794c03b69e77febe7ebcb1fcda55db)
...
- Bump the github-actions group across 1 directory with 5 updates. [eda0a1b](https://github.com/callowayproject/project-forge/commit/eda0a1bac2ecdfc58afebc02f7bca432feca0470)
...
- Replace `logging.getLogger` with `get_indented_logger` in `caching.py` for structured logging. [44bb911](https://github.com/callowayproject/project-forge/commit/44bb9112ec6bfefab07b94ab13780d0a9249b453)

- Simplify `IndentedLoggerAdapter` by removing unused `setup_logging` and refining `VERBOSITY` structure; add test for `process` kwargs type. [6c433c0](https://github.com/callowayproject/project-forge/commit/6c433c0d7e5f5dadde50e02398c3fae3c21a67bc)

- Replace `logging.getLogger` with `get_indented_logger` in `render.py` for structured logging. [6ff9f83](https://github.com/callowayproject/project-forge/commit/6ff9f836f327f3db7675915acf780e5023feaa40)

- Cache default environment for expression rendering to improve performance. [5e3aad7](https://github.com/callowayproject/project-forge/commit/5e3aad7be3f526394ce3be407a894e5eb8253b78)

- Annotate `default` in `parse_git_path` as `PathInfo` for improved type clarity. [06b6867](https://github.com/callowayproject/project-forge/commit/06b6867fb375cbf88864747bf7a95bd621d1ba37)

- Use `TEMPORARY_CACHE_DIR` for temporary caching instead of `TemporaryDirectory`. [614ac8d](https://github.com/callowayproject/project-forge/commit/614ac8d67afd864430007d2f381bafa5c2a38c53)

- [pre-commit.ci] pre-commit autoupdate. [dbc7cd1](https://github.com/callowayproject/project-forge/commit/dbc7cd1c487d94e9ffe82337a11740f9dcfd4176)

  **updates:** - [github.com/astral-sh/ruff-pre-commit: v0.11.8 → v0.11.11](https://github.com/astral-sh/ruff-pre-commit/compare/v0.11.8...v0.11.11)

### Updates

- Update dependencies. [aedf2e0](https://github.com/callowayproject/project-forge/commit/aedf2e02069bab6facd5449ae2eb5f95ae75042a)

- Remove mdformat from pre-commit. [a1d4e95](https://github.com/callowayproject/project-forge/commit/a1d4e9523bb9bd7e6cc473c08fbfc67c59df0ec1)

- Remove unused `TemporaryDirectory` mock in caching test. [1364515](https://github.com/callowayproject/project-forge/commit/1364515f29b0b7c9ba9598244fd1effdf8b3d8ad)

- Update merge method options in composition field description. [6746c0c](https://github.com/callowayproject/project-forge/commit/6746c0c5e0b6b3250e7b43eefd2bbf7b18a55e44)

- Rename `overwrite` merge method to `update` for clarity. [aff2ec7](https://github.com/callowayproject/project-forge/commit/aff2ec7ca355edce4bc25791c800adeb53b042c3)

- Update pre-commit configuration: add pyupgrade hook, remove mdformat. [ce67fa9](https://github.com/callowayproject/project-forge/commit/ce67fa9b246506b6173033aeedcc60d9a5eaa654)

- Update dependencies, .gitignore, and changelog configuration. [64502ff](https://github.com/callowayproject/project-forge/commit/64502ffe544fe9a8021e76b0a367aa2a9049a99c)
