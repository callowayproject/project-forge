...
class TestAskQuestion:
    ...
    def test_scalar_type_returns_correct_type(self, input_pipe, input_type: str, input_str: str, expected: Any):
        ...
        response = tui.ask_question("What is the answer?", type=input_type, input=input_pipe, output=DummyOutput())
    ...
    def test_bool_type_returns_bool(self, input_pipe):
        ...
        response = tui.ask_question("Question?", "bool", input=input_pipe, output=DummyOutput())
    ...
    def test_bool_type_with_default_returns_default(self, input_pipe):
        ...
        input_pipe.send_text(KeyInputs.ENTER)
        response = tui.ask_question("Question?", "bool", default=True, input=input_pipe, output=DummyOutput())
        assert response is True
        input_pipe.send_text(KeyInputs.ENTER)
        response = tui.ask_question("Question?", "bool", default=False, input=input_pipe, output=DummyOutput())
        assert response is False
